		...
		<table class="form-table">
			<tbody>
				<tr>
					...
					<td>
						<input name="wpfluxbb[fluxbb_config_file]" id="fluxbb_config_file" type="text" value="" />
						<button id="wpfluxbb_scan_config_file" class="button button-secondary button-small">Scan folders</button>
						<div id="wpfluxbb_scan_results"></div>
					</td>
				</tr>
			</tbody>
		</table>
		...
		<table class="form-table" style="max-width:64em">
			<tbody>
				<tr>
					...
					<td>
						<label><input name="wpfluxbb[auto_insert_user]" type="radio" value="1"> <?php _e( 'On', 'wp-fluxbb' ); ?></label>
						<label><input name="wpfluxbb[auto_insert_user]" type="radio" value="0"> <?php _e( 'Off', 'wp-fluxbb' ); ?></label>
